...
class CLEyeCameraCapture
{
		...
		static DWORD WINAPI moveMonitorThread(LPVOID instance)
		{
			CLEyeCameraCapture *pThis = (CLEyeCameraCapture *)instance;
			pThis->startMoveMonitor();
			return 0;
		}
		static DWORD WINAPI moveDirectionMonitorThread(LPVOID instance)
		{
			CLEyeCameraCapture *pThis = (CLEyeCameraCapture *)instance;
			pThis->startMoveDirectionMonitor();
			return 0;
		}
	...
	public:
		...
		int w, h;
		/*Detecting trigger click and sending mouse click*/
		void startMoveMonitor();
		bool is_trigger_pressed;
		void leftClick();
		/*Detecting the arrow keys*/
		void startMoveDirectionMonitor();
		void rightArrowDown();
		void rightArrowUp();
		void leftArrowDown();
		void leftArrowUp();
	...
	private:
		...
		static void switch_mmode( int position, void* obj )
		{
			CLEyeCameraCapture* myObj = (CLEyeCameraCapture*) obj; //recast 
			mmode = position;
		}
